...
/**
 * 함수 호출 시점에만 process.env 읽기 (import/top-level에서 읽지 않음)
 * bracket notation으로 빌드 타임 정적 치환 방지
 * @returns {{ supabaseUrl: string, serviceKey: string }}
 */
...
/**
 * @param {{ supabaseUrl?: string, serviceKey?: string }} [override] handler에서 전달 권장
 */
